...
import { AdminPromotionShell } from '@/components/admin/admin-promotion-shell'
import { ConfirmSendModal, CreatePromotionDrawer } from '@/components/admin/promotion-dialogs'
import { PromotionStats } from '@/components/admin/promotion-stats'
import { PromotionTable } from '@/components/admin/promotion-table'
import { Button } from '@/components/ui/button'
import { adminPromotions, type AdminPromotion } from '@/data/admin-promotions'
